...
function DictionaryContainer() {
    ...
    let cryptoData = [
        ...
        { name: "FOMO", description: "FOMO (Fear Of Missing Out/Strach Przed Pominięciem) to określenie inwestorów, którzy panicznie dokonują zakupu kryptowalut w obawie przed dalszymi wzrostami, z pominięciem ich na danym rynku. Inwestor w takiej sytuacji, kupując monety, często niezważa na fundamentalne podstawy, które stoją za danym projektem. Zakupu dokonuje jedynie pod wpływem emocji, aby załapać się na wzrost ceny. Niestety często kupujący w takim przypadku, z czasem, pozostają z workiem bezwartościowych monet." },
        //H
